...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active"><a href="{{ route('admin.transaksi.index') }}">Transaction</a></div>
    ...
    <div class="card">
        <div class="card-body">
            @if($errors->has)
                ...
                @endforeach
            @endif
            <form action="{{ route('admin.transaksi.update',$items->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
            ...
            <div class="">
                <div class="table-responsive">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($items->detailtransaction->cart as $cart)
                                <tr>
